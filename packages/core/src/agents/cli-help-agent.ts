...
const CliHelpReportSchema = z.object({
  answer: z
    .string()
    .describe('The detailed answer to the user question about Bare-AI CLI.'),
  sources: z
    .array(z.string())
...
/**
 * An agent specialized in answering questions about Bare-AI CLI itself,
...
export const CliHelpAgent = (
  ...
  description:
    'Specialized agent for answering questions about the Bare-AI CLI application. Invoke this agent for questions regarding CLI features, configuration schemas (e.g., policies), or instructions on how to create custom subagents. It queries internal documentation to provide accurate usage guidance.',
  inputConfig: {
    inputSchema: {
      type: 'object',
      properties: {
        question: {
          type: 'string',
          description: 'The specific question about Bare-AI CLI.',
        },
      },
      required: ['question'],
    },
  ...
  promptConfig: {
    query:
      'Your task is to answer the following question about Bare-AI CLI:\n' +
      '<question>\n' +
      '${question}\n' +
      '</question>',
    systemPrompt:
      "You are **CLI Help Agent**, an expert on Bare-AI CLI. Your purpose is to provide accurate information about Bare-AI CLI's features, configuration, and current state.\n\n" +
      '### Runtime Context\n' +
