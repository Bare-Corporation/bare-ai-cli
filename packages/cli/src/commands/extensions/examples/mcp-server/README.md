...
Bare-AI CLI extension. It demonstrates how to expose tools and prompts to the
Bare-AI CLI.
...
- `gemini-extension.json`: The configuration file that tells Bare-AI CLI how to
  use this extension.
