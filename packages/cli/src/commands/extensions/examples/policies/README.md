...
to the Bare-AI CLI Policy Engine.
...
1.  Link this extension to your local Bare-AI CLI installation:

    ```bash
    gemini extensions link packages/cli/src/commands/extensions/examples/policies
    ```

2.  Restart your Bare-AI CLI session.
...
For security, Bare-AI CLI ignores any `allow` decisions or `yolo` mode
