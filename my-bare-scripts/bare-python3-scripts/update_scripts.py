...
TRANSFORMER = r"""/*
 * ==========================================================================================
 * NiFi Groovy Script: FreeAgent Supplier Bill to [INTERNAL_SERVICE] Transformer (v1.0)
 * ==========================================================================================
 * Purpose:
 * Transforms FreeAgent /v2/bills JSON -> [INTERNAL_SERVICE] Supplier Invoice payload.
 *
 * Mapping:
...
try {
    ...
    flowFile = session.write(flowFile, { inputStream, outputStream ->
        ...
        // Build [INTERNAL_SERVICE] row payload
        def row = [:]
