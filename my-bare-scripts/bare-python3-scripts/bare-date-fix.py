...
req = urllib.request.Request("http://[INTERNAL_IP]/api/user/token-auth/", data=data, headers={"Content-Type": "application/json"})
...
for i, issue in enumerate(issues):
    ...
    req = urllib.request.Request(
        "http://[INTERNAL_IP]/api/database/fields/" + str(fid) + "/",
        data=payload,
