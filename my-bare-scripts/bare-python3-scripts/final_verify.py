...
print()
print('Note: SSL errors are from InvokeHTTP in Bare-IO_v2.1_Invoke_[INTERNAL_SERVICE] group.')
print('These may be pre-existing or related to [INTERNAL_SERVICE] API TLS requirements.')
print('The [INTERNAL_SERVICE] API itself is reachable (curl test passed, returns 401 without auth).')
