...
CREATE_RESP=$(curl -s -X POST http://100.64.0.19/api/user/ -H "Content-Type: application/json" -d "{"name":"bare-AI Admin","email":"admin@bare-table.com","password":"${ADMIN_PASSWORD}","authenticate":true}")
