...
const cliConfig = {
  ...
  entryPoints: { 'bare-ai': 'packages/cli/index.ts' },
  outdir: 'bundle',
  splitting: true,
  define: {
...
Promise.allSettled([
  ...
  if (cliResult.status === 'rejected') {
    console.error('bare-ai.js build failed:', cliResult.reason);
    process.exit(1);
  }
  // error in a2a-server bundling will not stop bare-ai.js bundling process
